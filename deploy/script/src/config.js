...
const deployConfig =  {
  api: {
    dockerRepo: 'registry.digitalocean.com/paralect/listed-kit-api',
    dir: `${rootDir}/api`,
    folder: 'api',
  },
  web: {
    dockerRepo: 'registry.digitalocean.com/paralect/listed-kit-web',
    dir: `${rootDir}/b2b-onboarding-supabase`,
    folder: 'web',
  },
};
